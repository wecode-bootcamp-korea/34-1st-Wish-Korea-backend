...
class ProductListView(View):
    def get(self, request):
        try:
            ...
            # if request.GET.get('category_id'):
                # products = Product.objects.filter(sub_category__category_id = request.GET['category_id'])
# 
            # if request.GET.get('sub_category_id'):
                # products = Product.objects.filter(sub_category_id = request.GET['sub_category_id'])
